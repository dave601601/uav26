 ...
 *
 * cruise (1.0) and max_vxy (1.3) are flight-proven in sim with speed_scale
 * deceleration scheduling and front-camera hints.
 *
 ...
 * the constant cruise (1.0), removing the squeeze: kp_xy=0.8 became a
